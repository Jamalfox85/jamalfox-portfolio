    ...
    -->
        <div v-for="project in projects" :class="getProjectClass(project.type)">
            ...
            <div class="project-main">
                <div class="project-col-left">
                    ...
                    <n-collapse default-expanded-names="" accordion>
                        ...
                        <n-collapse-item title="Skills" name="skills">
                            <div class="skills">
                                <span
                                    v-for="skill in getProjectSkills(
                                        project.skills
                                    )"
                                    :key="skill.id"
                                    class="skill"
                                >
                                    <img
                                        :src="`./images/skill-icons/${skill.img}.svg`"
                                    />
                                </span>
                            </div>
                        </n-collapse-item>
                ...
                <div class="project-col-right" v-if="project.video_url">
...
import { NButton, NCollapse, NCollapseItem, NCarousel } from "naive-ui";

export default {
    components: { ProjectBlock, NButton, NCollapse, NCollapseItem, NCarousel },
    data() {
        return {
            toggler: false,
    ...
    methods: {
        getProjectClass(projectType) {
            ...
            if (projectType === 4) return "freelance-project";
